      ...
      <div className="min-h-screen bg-[#09090b] text-white p-6">
        <div className="max-w-4xl mx-auto">
          <header className="mb-10 text-center">
            ...
            <p className="text-zinc-400">Selecciona un evento para comenzar el check-in</p>
          </header>
            ...
            <div className="grid gap-4">
              {events.map((event) => (
                <Link
                  ...
                  className="group block bg-[#18181b] border border-[#27272a] rounded-xl p-6 hover:border-blue-500/50 hover:bg-[#18181b]/80 transition-all duration-300"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className="w-6 h-6 text-zinc-600 group-hover:text-blue-400 group-hover:translate-x-1 transition-all" />
                  </div>
                </Link>
              ))}
            </div>
